...
- (void)setYLabels:(NSArray*)yLabels
{
    ...
    if (yStep == 0.0)
    {
        ...
        PNChartLabel* maxLabel = [[PNChartLabel alloc]
            initWithFrame:CGRectMake(0.0, 0.0, (NSInteger)_chartMargin, (NSInteger)_yLabelHeight)];
...
- (void)setXLabels:(NSArray*)xLabels withWidth:(CGFloat)width
{
    ...
    if (_showLabel)
    {
        for (int index = 0; index < xLabels.count; index++)
        {
            ...
            PNChartLabel* label =
                [[PNChartLabel alloc] initWithFrame:CGRectMake(x, y, (NSInteger)_xLabelWidth, (NSInteger)_chartMargin)];
...
- (void)updateChartData:(NSArray*)data
{
    ...
    for (NSUInteger lineIndex = 0; lineIndex < self.chartData.count; lineIndex++)
    {
        ...
        pointPathAnimation.timingFunction =
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
        [text drawInRect:rect withFont:font lineBreakMode:NSLineBreakByTruncatingTail alignment:NSTextAlignmentLeft];
#pragma clang diagnostic pop
    }
}
